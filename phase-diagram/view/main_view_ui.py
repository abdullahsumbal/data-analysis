...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(681, 409)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(9, 9, 661, 361))
        ...
        self.button_plot = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.button_plot.setEnabled(False)
        self.button_plot.setObjectName("button_plot")
        self.gridLayout.addWidget(self.button_plot, 1, 1, 1, 1)
